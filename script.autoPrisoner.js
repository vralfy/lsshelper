document.lss_helper.autoPrisoner = (force) => {
  ...
  document.lss_helper.autoPrisonerFiltered();
};

document.lss_helper.autoPrisonerFiltered = (_types) => {
  ...
  document.lss_helper.vehicles
    ...
    .shuffle()
    .forEach((call) => {
      fetch((document.lss_helper.url ?? 'https://www.leitstellenspiel.de') + '/vehicles/' + call.id, header)
